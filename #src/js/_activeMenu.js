...
//                 if (element.offsetTop - menuTopEl.clientHeight <= scrollDistance) {
...
//============== Selecting menu items on click =============================
{
    const menuTtopEl = document.querySelector('.header__menu-list')
        ...
        function singleSelect(li) {
            ...
            let active = menuTtopEl.querySelectorAll('.header__menu-link--active');
            ...
            li.classList.add('header__menu-link--active');
        }
}
//--------------------------------------------------------------------------